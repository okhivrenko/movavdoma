...
- Version 1.3.2 deployed on 3 August 2026: public brand, Worker URL, and
  Monobank jar identifiers moved from production code into validated
  Cloudflare Worker vars; D1 has no pending migrations and production health
  returned `MovaYakVDoma is running.`
