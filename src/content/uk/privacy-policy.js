export const privacyPolicy = Object.freeze({
  ...
  <p>Нагадування можна вимкнути у «⏰ Розклад». Щоб попросити доступ, виправлення або видалення даних, натисніть «📩 Зв'язатися з нами» й надішліть <code>Delete my data</code> або <code>Видалити мої дані</code>. Для захисту даних ми можемо попросити підтвердити запит із того ж Telegram-акаунта.</p>
