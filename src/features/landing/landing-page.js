...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; } html { scroll-behavior: smooth; } body { margin: 0; line-height: 1.5; } a { color: inherit; } .wrap { width: min(1120px, calc(100% - 40px)); margin: auto; }
    ...
    .nav, .hero-grid, section { position: relative; z-index: 1; } .nav { display: flex; align-items: center; justify-content: space-between; gap: 16px; } .brand { font-size: 1.1rem; font-weight: 800; letter-spacing: -.03em; text-decoration: none; } .brand span { color: #b57b00; } .nav a:not(.brand) { font-weight: 700; text-underline-offset: 4px; }
...
<body>
  <header class="hero"><div class="wrap">
    <nav aria-label="Головна навігація"><a class="brand" href="/">Mova<span>Yak</span>VDoma</a><a href="#how-it-works">Як це працює</a></nav>
  ...
  <main>
    ...
    <section class="soft" id="how-it-works"><div class="wrap"><p class="section-label">Простий ритуал</p><h2>Як це працює</h2><div class="steps"><article class="card"><span class="number">1</span><h3>Додай слово</h3><p>Надішли англійське слово або фразу просто в чаті з ботом.</p></article><article class="card"><span class="number">2</span><h3>Обери значення</h3><p>Якщо значень кілька, бот допоможе вибрати саме потрібне.</p></article><article class="card"><span class="number">3</span><h3>Зрозумій у контексті</h3><p>Отримай переклад і рівно два англійські приклади з перекладом.</p></article><article class="card"><span class="number">4</span><h3>Повертайся щодня</h3><p>Повторюй слова, відкривай щоденну картку та бережи свій прогрес.</p></article></div></div></section>
