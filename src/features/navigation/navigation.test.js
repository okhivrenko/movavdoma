...
test("navigation resolves Ukrainian button text to stable internal actions", () => {
    ...
    assert.equal(menuActionFromText("⏰ Налаштування\n(10:00 - A0)"), MENU_ACTION.SETTINGS);
...
test("navigation keyboard and feedback cancellation retain current Ukrainian UI", () => {
    ...
    assert.deepEqual(keyboard.keyboard[2].map((button) => button.text), ["🌐 Перекласти текст", "⏰ Налаштування\n(18:00 - C1)"]);
